...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT(
                SE_GRV,    KC_1,  KC_1,    KC_3,    KC_4,    KC_5,    KC_6,   KC_7,     KC_8,    KC_9,     KC_0,    SE_PLUS,
   ...
   ALGR_T(KC_ESC),   MO(_FN), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_H,     KC_J,    KC_K,     KC_L,    SE_OSLH, SE_AE,       KC_ENTER,
            KC_LSHIFT, SE_LESS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_N,      KC_M,    KC_COMMA, KC_DOT,  SE_MINS, KC_RSHIFT,
               KC_LCTRL, KC_LGUI, KC_LALT, SE_APOS, MO(_FN), KC_ALGR, KC_SPC, MO(_FN),  SE_QUOT, KC_DEL,   KC_PGDN,  KC_PGUP
    ),
    [_FN] = LAYOUT(
           QMKBEST, QMKURL,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,   _______,    _______,
        RESET,  _______,  _______,  _______,  _______,  _______,  _______,  C(KC_LEFT),  KC_UP,  C(KC_RIGHT),  _______,  _______,  MU_MOD,
     RESET,  _______,  _______,  _______,  _______,  KC_LSHIFT,  _______,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_END,  _______,  MU_TOG,
